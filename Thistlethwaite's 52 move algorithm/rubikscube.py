...
class Cube:
    ...
    def L2(self):  self._rotate_face(LEFT, ROT_YZ_CC);  self._rotate_face(LEFT, ROT_YZ_CC)
    def R2(self):  self._rotate_face(RIGHT, ROT_YZ_CW);  self._rotate_face(RIGHT, ROT_YZ_CW)
    def U2(self):  self._rotate_face(UP, ROT_XZ_CW);  self._rotate_face(UP, ROT_XZ_CW)
    def D2(self):  self._rotate_face(DOWN, ROT_XZ_CC);  self._rotate_face(DOWN, ROT_XZ_CC)
    def F2(self):  self._rotate_face(FRONT, ROT_XY_CW);  self._rotate_face(FRONT, ROT_XY_CW)
    def B2(self):  self._rotate_face(BACK, ROT_XY_CC);  self._rotate_face(BACK, ROT_XY_CC)
